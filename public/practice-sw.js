const CACHE = 'battle-practice-shell-v37';
const FILES = ['index.html', 'hall-world.js', 'hall-art.js', 'hall-character-art.js', 'town-hall.js', 'town-hall.css', 'village.js', 'village-interiors.js', 'village-interiors.css', 'village-art.js', 'village.css', 'pack-cinema.js', 'pack-cinema.css', 'style.css', 'studio.css', 'studio.js', 'ruby-shop.js', 'pet-interactions.js', 'companions.js', 'companion-explorer.js', 'ruby-shop.css', 'app.js', 'ascend-utils.js', 'gem-colors.js', 'amulets.js', 'gem-workshop.js', 'dye-mode.js', 'practice-engine.js', 'battle-effects.js', 'brawl-turns.js', 'practice-battle.js', 'practice-worker.js'];
