const CACHE = 'battle-practice-shell-v9';
const FILES = ['index.html', 'style.css', 'studio.css', 'studio.js', 'app.js', 'ascend-utils.js', 'gem-colors.js', 'amulets.js', 'gem-workshop.js', 'dye-mode.js', 'practice-engine.js', 'practice-battle.js', 'practice-worker.js'];
