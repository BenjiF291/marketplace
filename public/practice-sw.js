const CACHE = 'battle-practice-shell-v30';
const FILES = ['index.html', 'village.js', 'village-art.js', 'village.css', 'pack-cinema.js', 'pack-cinema.css', 'style.css', 'studio.css', 'studio.js', 'ruby-shop.js', 'pet-interactions.js', 'companions.js', 'companion-explorer.js', 'ruby-shop.css', 'app.js', 'ascend-utils.js', 'gem-colors.js', 'amulets.js', 'gem-workshop.js', 'dye-mode.js', 'practice-engine.js', 'battle-effects.js', 'brawl-turns.js', 'practice-battle.js', 'practice-worker.js'];
...
self.addEventListener('fetch', event => {
  ...
  const key = isHome ? new URL('index.html', 'village.js', 'village-art.js', 'village.css', 'pack-cinema.js', 'pack-cinema.css',root).href : url.href;
