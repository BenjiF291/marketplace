(function(root){
 ...
 const api={SEATS,SKINS,HAIR,COATS,EYES,TRIMS,PANTS,STYLES,OUTFITS,HEADWEAR,CAPES,ACCESSORIES,BEARDS,character,position,route,blocked};if(typeof module!=='undefined')module.exports=api;else root.HallWorld=api;
