...
(() => {
 ...
 window.playSpecialPackOpening=(result,theme)=>{
  ...
  else {schedule(()=>{d.dataset.phase='charge';},900);schedule(()=>{d.dataset.phase='burst';},3100);schedule(reveal,4200);}
  return true;
 };
})();
